import { getDefaultConfig } from '/1/module/esm/0/l/en-US/mi/lightning/configProvider#defaultConfig/v/1_14_2-alpha/latest/lightning_configProvider_defaultConfig.js'; // Closure to hold the APIs if and when available
