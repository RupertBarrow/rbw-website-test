...
import _tmpl from "/1/module/esm/0/l/en-US/mi/lightning/input#input.html/v/1_14_2-alpha/latest/lightning_input_input_html.js";
import labelA11yTriggerText from '/1/module/esm/0/l/en-US/mi/@salesforce/label/LightningColorPicker.a11yTriggerText/v/1_14_2-alpha/latest/@salesforce_label_LightningColorPicker_a11yTriggerText.js';
import labelInputFileBodyText from '/1/module/esm/0/l/en-US/mi/@salesforce/label/LightningInputFile.bodyText/v/1_14_2-alpha/latest/@salesforce_label_LightningInputFile_bodyText.js';
import labelInputFileButtonLabel from '/1/module/esm/0/l/en-US/mi/@salesforce/label/LightningInputFile.buttonLabel/v/1_14_2-alpha/latest/@salesforce_label_LightningInputFile_buttonLabel.js';
import labelMessageToggleActive from '/1/module/esm/0/l/en-US/mi/@salesforce/label/LightningControl.activeCapitalized/v/1_14_2-alpha/latest/@salesforce_label_LightningControl_activeCapitalized.js';
import labelMessageToggleInactive from '/1/module/esm/0/l/en-US/mi/@salesforce/label/LightningControl.inactiveCapitalized/v/1_14_2-alpha/latest/@salesforce_label_LightningControl_inactiveCapitalized.js';
...
import labelClearInput from '/1/module/esm/0/l/en-US/mi/@salesforce/label/LightningControl.clear/v/1_14_2-alpha/latest/@salesforce_label_LightningControl_clear.js';
import labelLoadingIndicator from '/1/module/esm/0/l/en-US/mi/@salesforce/label/LightningControl.loading/v/1_14_2-alpha/latest/@salesforce_label_LightningControl_loading.js';
import labelNumberIncrementCounter from '/1/module/esm/0/l/en-US/mi/@salesforce/label/LightningInputNumber.incrementCounter/v/1_14_2-alpha/latest/@salesforce_label_LightningInputNumber_incrementCounter.js';
import labelNumberDecrementCounter from '/1/module/esm/0/l/en-US/mi/@salesforce/label/LightningInputNumber.decrementCounter/v/1_14_2-alpha/latest/@salesforce_label_LightningInputNumber_decrementCounter.js';
import labelHelpTextAlternativeText from '/1/module/esm/0/l/en-US/mi/@salesforce/label/LightningInput.helptextAlternativeText/v/1_14_2-alpha/latest/@salesforce_label_LightningInput_helptextAlternativeText.js';
import userTimeZone from '/1/module/esm/0/l/en-US/mi/@salesforce/i18n/timeZone/v/1_14_2-alpha/latest/@salesforce_i18n_timeZone.js';
import formFactor from '/1/module/esm/0/l/en-US/mi/@salesforce/client/formFactor/v/1_14_2-alpha/latest/@salesforce_client_formFactor.js';
import { classSet, formatLabel } from '/1/module/esm/0/l/en-US/mi/lightning/utils/v/1_14_2-alpha/latest/lightning_utils.js';
import { assert, classListMutation, getRealDOMId, isSafari, isNativeComponent, isNotUndefinedOrNull, isUndefinedOrNull, normalizeAriaAttribute, normalizeBoolean, normalizeKeyValue, normalizeString, synchronizeAttrs, decorateInputForDragon, setDecoratedDragonInputValueWithoutEvent } from '/1/module/esm/0/l/en-US/mi/lightning/utilsPrivate/v/1_14_2-alpha/latest/lightning_utilsPrivate.js';
import AriaObserver from '/1/module/esm/0/l/en-US/mi/lightning/ariaObserver/v/1_14_2-alpha/latest/lightning_ariaObserver.js';
import { normalizeInput } from '/1/module/esm/0/l/en-US/mi/lightning/input#normalize/v/1_14_2-alpha/latest/lightning_input_normalize.js';
import { normalizeDate, normalizeDateTimeToUTC, normalizeTime, normalizeUTCDateTime } from '/1/module/esm/0/l/en-US/mi/lightning/input#dateTimeUtil/v/1_14_2-alpha/latest/lightning_input_dateTimeUtil.js';
import { isAfter, isBefore } from '/1/module/esm/0/l/en-US/mi/lightning/internationalizationLibrary/v/1_14_2-alpha/latest/lightning_internationalizationLibrary.js';
import { FieldConstraintApiWithProxyInput, InteractingState, normalizeVariant, VARIANT } from '/1/module/esm/0/l/en-US/mi/lightning/inputUtils/v/1_14_2-alpha/latest/lightning_inputUtils.js';
import { calculateFractionDigitsFromStep, formatNumber, fromIsoDecimal, hasValidNumberShortcut, hasValidNumberSymbol, increaseNumberByStep, isValidNumber, isValidNumberCharacter, normalizeNumber, toIsoDecimal } from '/1/module/esm/0/l/en-US/mi/lightning/input#numberUtil/v/1_14_2-alpha/latest/lightning_input_numberUtil.js';
import { isValidEmail, isValidMultipleEmails } from '/1/module/esm/0/l/en-US/mi/lightning/input#emailUtil/v/1_14_2-alpha/latest/lightning_input_emailUtil.js';
import { InputSelectionCache } from '/1/module/esm/0/l/en-US/mi/lightning/input#selection/v/1_14_2-alpha/latest/lightning_input_selection.js';
const i18n = {
