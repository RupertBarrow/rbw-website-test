...
import _tmpl from "/1/module/esm/0/l/en-US/mi/lightning/lookupAddress#lookupAddress.html/v/1_14_2-alpha/latest/lightning_lookupAddress_lookupAddress_html.js";

/* eslint-disable @lwc/lwc/no-api-reassignments */
import lang from '/1/module/esm/0/l/en-US/mi/@salesforce/i18n/lang/v/1_14_2-alpha/latest/@salesforce_i18n_lang.js';
import { toHighlightParts } from '/1/module/esm/0/l/en-US/mi/lightning/lookupAddress#highlight/v/1_14_2-alpha/latest/lightning_lookupAddress_highlight.js';
import { classSet } from '/1/module/esm/0/l/en-US/mi/lightning/utils/v/1_14_2-alpha/latest/lightning_utils.js';
import { normalizeVariant, VARIANT, debounce } from '/1/module/esm/0/l/en-US/mi/lightning/inputUtils/v/1_14_2-alpha/latest/lightning_inputUtils.js';
import { registerMessageHandler, unregisterMessageHandler, createMessage, postMessage } from '/1/module/esm/0/l/en-US/mi/lightning/messageDispatcher/v/1_14_2-alpha/latest/lightning_messageDispatcher.js';
import { normalizeBoolean, synchronizeAttrs } from '/1/module/esm/0/l/en-US/mi/lightning/utilsPrivate/v/1_14_2-alpha/latest/lightning_utilsPrivate.js';
import { buildMapSourceUrl } from '/1/module/esm/0/l/en-US/mi/lightning/mapUtils/v/1_14_2-alpha/latest/lightning_mapUtils.js';
import { INTERNAL_GOOGLE_LOGO, POWERED_BY_GOOGLE } from '/1/module/esm/0/l/en-US/mi/lightning/lookupAddress#googleLogo/v/1_14_2-alpha/latest/lightning_lookupAddress_googleLogo.js';
import { getLocation } from '/1/module/esm/0/l/en-US/mi/lightning/lookupAddress#location/v/1_14_2-alpha/latest/lightning_lookupAddress_location.js';
