...
import { updateStaleModule } from '/1/module/esm/0/l/en-US/mi/lwr/hmr%23util/swap/v/0_5_11/latest/lwr_hmr_util_swap.js';
...
async function moduleUpdate(payload) {
    ...
    const oldModule = await load(lastEvalutedUri, 'lwr/hmr/v/0_5_11');
    const newModule = await load(newUri, 'lwr/hmr/v/0_5_11');
