...
export { Direction } from '/1/module/esm/0/l/en-US/mi/lightning%2FpositionLibrary%23direction%2Fv%2F1_14_2-alpha/latest/lightning_positionLibrary_direction.js';
import { Constraint } from '/1/module/esm/0/l/en-US/mi/lightning%2FpositionLibrary%23constraint%2Fv%2F1_14_2-alpha/latest/lightning_positionLibrary_constraint.js';
import { checkFlipPossibility, Direction, flipDirection, mapToHorizontal, mapToVertical, normalizeDirection } from '/1/module/esm/0/l/en-US/mi/lightning%2FpositionLibrary%23direction%2Fv%2F1_14_2-alpha/latest/lightning_positionLibrary_direction.js';
import { createProxy } from '/1/module/esm/0/l/en-US/mi/lightning%2FpositionLibrary%23elementProxyCache%2Fv%2F1_14_2-alpha/latest/lightning_positionLibrary_elementProxyCache.js';
import { getPositionTarget, getScrollableParent, getScrollableParentFromEventPath, isDomNode, normalizeElement, normalizePosition, requestAnimationFrameAsPromise, WindowManager } from '/1/module/esm/0/l/en-US/mi/lightning%2FpositionLibrary%23util%2Fv%2F1_14_2-alpha/latest/lightning_positionLibrary_util.js';
import { addConstraints, bindEvents, nextIndex, rebaseIndex, reposition, scheduleReposition } from '/1/module/esm/0/l/en-US/mi/lightning%2FpositionLibrary%23reposition%2Fv%2F1_14_2-alpha/latest/lightning_positionLibrary_reposition.js';
...
import { Relationship } from '/1/module/esm/0/l/en-US/mi/lightning%2FpositionLibrary%23relationship%2Fv%2F1_14_2-alpha/latest/lightning_positionLibrary_relationship.js';
import { OverlayDetector } from '/1/module/esm/0/l/en-US/mi/lightning%2FpositionLibrary%23overlayDetector%2Fv%2F1_14_2-alpha/latest/lightning_positionLibrary_overlayDetector.js';
...
function createRelationship(originalConfig, disableReposition, eventComposedPath) {
  ...
  if (config.scrollableParentBound && scrollableParent || modal.isInsideModal && modal.overlay && autoShrink) {
    let parent;
